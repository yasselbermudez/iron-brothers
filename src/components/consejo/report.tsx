...
export default function Report ({chatMembers}:ReportProps){
    ...
    const memberName = chatMembers.find(m => m.user_id === selectedMember)?.user_name || "Miembro";
  ...
  const handleSelectedMember = (user_id:string) => {
    ...
    return(
        ...
        <Card className="bg-slate-900 border-slate-800">
              <CardHeader>
                <CardTitle className="text-white">Reportar Incidente</CardTitle>
